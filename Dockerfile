...
RUN [ ! -e "${HG19_FA}" ] && echo "hg19 reference file not found at location: ${HG19_FA}" && exit 1


# ~~~~~ MSI SENSOR ~~~~~ #
ENV HG19_MICROSATELLITES /opt/bin/msisensor/hg19_microsatellites.list
RUN cd /opt/bin && git clone https://github.com/ding-lab/msisensor.git && cd msisensor && make
